...
namespace Peng
{
	void bfs(vector<vector<int>>adjacency_list, int source)//leetcode:310
	{
	...
	void bfs(vector<set<int>>adjacency_list, int source)//leetcode:310
	{
		vector<bool> marked(adjacency_list.size(), false);
		queue<int> q;
		q.push(source);
